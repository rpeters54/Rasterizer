...
VL_ATTR_COLD void Vtb_axi_fifo___024root__trace_init_sub__TOP__0(Vtb_axi_fifo___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+60,0,"PERIOD",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+61,0,"WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+62,0,"DEPTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+63,0,"PTR_WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+63,0,"COUNT_WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->pushPrefix("buffer", VerilatedTracePrefixType::ARRAY_UNPACKED);
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+47+i*1,0,"",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, true,(i+0), 7,0);
    }
    tracep->popPrefix();
...
VL_ATTR_COLD void Vtb_axi_fifo___024root__trace_full_0_sub_0(Vtb_axi_fifo___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+47,(vlSelfRef.tb_axi_fifo__DOT__fifo2__DOT__buffer[0]),8);
    bufp->fullCData(oldp+48,(vlSelfRef.tb_axi_fifo__DOT__fifo2__DOT__buffer[1]),8);
    bufp->fullCData(oldp+49,(vlSelfRef.tb_axi_fifo__DOT__fifo2__DOT__buffer[2]),8);
    bufp->fullCData(oldp+50,(vlSelfRef.tb_axi_fifo__DOT__fifo2__DOT__buffer[3]),8);
    bufp->fullSData(oldp+51,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[0]),16);
    bufp->fullSData(oldp+52,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[1]),16);
    bufp->fullSData(oldp+53,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[2]),16);
    bufp->fullSData(oldp+54,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[3]),16);
    bufp->fullSData(oldp+55,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[4]),16);
    bufp->fullSData(oldp+56,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[5]),16);
    bufp->fullSData(oldp+57,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[6]),16);
    bufp->fullSData(oldp+58,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[7]),16);
    bufp->fullBit(oldp+59,(vlSelfRef.tb_axi_fifo__DOT__clk));
}
