...
VL_INLINE_OPT void Vtb_axi_fifo___024root___nba_sequent__TOP__0(Vtb_axi_fifo___024root* vlSelf) {
    ...
    if (vlSelfRef.tb_axi_fifo__DOT__rst_n) {
        if (((IData)(vlSelfRef.tb_axi_fifo__DOT__vld_in2) 
             & (4U > (IData)(vlSelfRef.tb_axi_fifo__DOT__fifo2__DOT__count)))) {
        ...
        if (((IData)(vlSelfRef.tb_axi_fifo__DOT__vld_in1) 
            ...
            if ((0U == (IData)(vlSelfRef.tb_axi_fifo__DOT__fifo1__DOT__count))) {
        ...
        if (((IData)(vlSelfRef.tb_axi_fifo__DOT__vld_out1) 
            ...
            vlSelfRef.tb_axi_fifo__DOT__data_out1 = 
                ((4U >= (7U & (IData)(vlSelfRef.tb_axi_fifo__DOT__fifo1__DOT__next_read_ptr)))
                 ...
                 [(7U & (IData)(vlSelfRef.tb_axi_fifo__DOT__fifo1__DOT__next_read_ptr))]
                  : 0ULL);
        ...
        if (((IData)(vlSelfRef.tb_axi_fifo__DOT__vld_in2) 
            ...
            if ((0U == (IData)(vlSelfRef.tb_axi_fifo__DOT__fifo2__DOT__count))) {
        ...
        if (((IData)(vlSelfRef.tb_axi_fifo__DOT__vld_in3) 
            ...
            if ((0U == (IData)(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__count))) {
