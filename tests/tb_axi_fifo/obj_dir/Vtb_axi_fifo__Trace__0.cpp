...
void Vtb_axi_fifo___024root__trace_chg_0_sub_0(Vtb_axi_fifo___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[3U]))) {
        ...
        bufp->chgCData(oldp+46,(vlSelfRef.tb_axi_fifo__DOT__fifo1__DOT__next_read_ptr),4);
        bufp->chgCData(oldp+47,(vlSelfRef.tb_axi_fifo__DOT__fifo2__DOT__buffer[0]),8);
        bufp->chgCData(oldp+48,(vlSelfRef.tb_axi_fifo__DOT__fifo2__DOT__buffer[1]),8);
        bufp->chgCData(oldp+49,(vlSelfRef.tb_axi_fifo__DOT__fifo2__DOT__buffer[2]),8);
        bufp->chgCData(oldp+50,(vlSelfRef.tb_axi_fifo__DOT__fifo2__DOT__buffer[3]),8);
        bufp->chgCData(oldp+51,(vlSelfRef.tb_axi_fifo__DOT__fifo2__DOT__next_read_ptr),3);
        bufp->chgSData(oldp+52,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[0]),16);
        bufp->chgSData(oldp+53,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[1]),16);
        bufp->chgSData(oldp+54,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[2]),16);
        bufp->chgSData(oldp+55,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[3]),16);
        bufp->chgSData(oldp+56,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[4]),16);
        bufp->chgSData(oldp+57,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[5]),16);
        bufp->chgSData(oldp+58,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[6]),16);
        bufp->chgSData(oldp+59,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__buffer[7]),16);
        bufp->chgCData(oldp+60,(vlSelfRef.tb_axi_fifo__DOT__fifo3__DOT__next_read_ptr),4);
    }
    bufp->chgBit(oldp+61,(vlSelfRef.tb_axi_fifo__DOT__clk));
}
