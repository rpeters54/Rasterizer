...
#endif
            VL_FATAL_MT("tb.all.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb___024root___ctor_var_reset(Vtb___024root* vlSelf) {
    ...
    vlSelf->tb_all__DOT__rastafarian__DOT__pixel_proc__DOT__unnamedblk4__DOT__i = 0;
    ...
    vlSelf->tb_all__DOT__rastafarian__DOT__pixel_proc__DOT____Vlvbound_h19821f78__0 = VL_RAND_RESET_I(32);
