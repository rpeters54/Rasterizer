...
class alignas(VL_CACHE_LINE_BYTES) Vtb_all___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        QData/*47:0*/ tb_all__DOT__rastafarian__DOT__inter_deltas_0_0;
        QData/*47:0*/ tb_all__DOT__rastafarian__DOT__inter_deltas_0_1;
        QData/*47:0*/ tb_all__DOT__rastafarian__DOT__inter_deltas_0_2;
