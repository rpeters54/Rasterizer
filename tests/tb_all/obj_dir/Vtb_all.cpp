...
void Vtb_all::eval_end_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+eval_end_step Vtb_all::eval_end_step\n"); );
#ifdef VM_TRACE
    // Tracing
...
//============================================================
// Events and timing
bool Vtb_all::eventsPending() { return !vlSymsp->TOP.__VdlySched.empty(); }

uint64_t Vtb_all::nextTimeSlot() { return vlSymsp->TOP.__VdlySched.nextTimeSlot(); }
