...
VL_ATTR_COLD void Vtb_tile___024root___ctor_var_reset(Vtb_tile___024root* vlSelf) {
    ...
    vlSelf->tb_tile__DOT__v0_x = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__v0_y = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__v0_z = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__v1_x = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__v1_y = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__v1_z = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__v2_x = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__v2_y = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__v2_z = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__in_color = VL_RAND_RESET_I(8);
    vlSelf->tb_tile__DOT__in_tile_x = VL_RAND_RESET_I(6);
    vlSelf->tb_tile__DOT__in_tile_y = VL_RAND_RESET_I(5);
    vlSelf->tb_tile__DOT__out_abs_pos_x = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__out_abs_pos_y = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__out_abs_pos_z = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__out_delta_0_x = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__out_delta_0_y = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__out_delta_0_z = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__out_delta_1_x = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__out_delta_1_y = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__out_delta_1_z = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__out_delta_2_x = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__out_delta_2_y = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__out_delta_2_z = VL_RAND_RESET_I(16);
    ...
    vlSelf->tb_tile__DOT__out_color = VL_RAND_RESET_I(8);
    vlSelf->tb_tile__DOT__out_tile_x = VL_RAND_RESET_I(6);
    vlSelf->tb_tile__DOT__out_tile_y = VL_RAND_RESET_I(5);
    ...
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__present_state = 0;
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__next_state = 0;
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__temp_start = VL_RAND_RESET_Q(48);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__temp_delta_0 = VL_RAND_RESET_Q(48);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__temp_delta_1 = VL_RAND_RESET_Q(48);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__temp_delta_2 = VL_RAND_RESET_Q(48);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__temp_edge_i = VL_RAND_RESET_I(32);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__temp_coeff_a = VL_RAND_RESET_I(32);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__temp_coeff_b = VL_RAND_RESET_I(32);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__temp_coeff_c = VL_RAND_RESET_I(32);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__temp_z = VL_RAND_RESET_I(32);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__temp_dzdx = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__temp_dzdy = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__v0 = VL_RAND_RESET_Q(48);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__v1 = VL_RAND_RESET_Q(48);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__v2 = VL_RAND_RESET_Q(48);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__abs_pos = VL_RAND_RESET_Q(48);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__delta_0 = VL_RAND_RESET_Q(48);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__delta_1 = VL_RAND_RESET_Q(48);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__delta_2 = VL_RAND_RESET_Q(48);
    for (int __Vi0 = 0; __Vi0 < 3; ++__Vi0) {
        vlSelf->tb_tile__DOT__u_tile_processor__DOT__edges[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__metadata = VL_RAND_RESET_I(19);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__coeff_A = VL_RAND_RESET_I(32);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__coeff_B = VL_RAND_RESET_I(32);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__coeff_C = VL_RAND_RESET_I(32);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__dzdx = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__dzdy = VL_RAND_RESET_I(16);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__z_current = VL_RAND_RESET_I(32);
    vlSelf->tb_tile__DOT__u_tile_processor__DOT__unnamedblk1__DOT__i = 0;
    vlSelf->__Vtask_tb_tile__DOT__u_tile_processor__DOT__compute_delta__25__out = VL_RAND_RESET_Q(48);
    vlSelf->__Vtask_tb_tile__DOT__u_tile_processor__DOT__compute_delta__26__out = VL_RAND_RESET_Q(48);
    vlSelf->__Vtask_tb_tile__DOT__u_tile_processor__DOT__compute_delta__27__out = VL_RAND_RESET_Q(48);
