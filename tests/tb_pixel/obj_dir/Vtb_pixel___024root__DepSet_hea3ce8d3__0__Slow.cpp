...
VL_ATTR_COLD void Vtb_pixel___024root___eval_initial__TOP(Vtb_pixel___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_pixel___024root___eval_initial__TOP\n"); );
    ...
    __Vtemp_1[1U] = 0x6978656cU;
    __Vtemp_1[2U] = 0x74625f70U;
...
VL_ATTR_COLD void Vtb_pixel___024root___eval_triggers__stl(Vtb_pixel___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_pixel___024root___eval_triggers__stl\n"); );
    Vtb_pixel__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
