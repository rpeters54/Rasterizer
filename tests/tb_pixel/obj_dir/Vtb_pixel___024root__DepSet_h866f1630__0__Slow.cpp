...
#endif
            VL_FATAL_MT("tb_pixel.sv", 4, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_pixel___024root___ctor_var_reset(Vtb_pixel___024root* vlSelf) {
    ...
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__present_state = VL_RAND_RESET_I(2);
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__next_state = VL_RAND_RESET_I(2);
    ...
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__delta_0 = VL_RAND_RESET_Q(48);
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__delta_1 = VL_RAND_RESET_Q(48);
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__delta_2 = VL_RAND_RESET_Q(48);
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__edge_0 = VL_RAND_RESET_I(32);
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__edge_1 = VL_RAND_RESET_I(32);
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__edge_2 = VL_RAND_RESET_I(32);
    ...
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__temp_coord = VL_RAND_RESET_Q(48);
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__temp_z_row_off = VL_RAND_RESET_I(32);
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__temp_edge_row_off = VL_RAND_RESET_I(32);
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__temp_z_col_off = VL_RAND_RESET_I(32);
    vlSelf->tb_pixel__DOT__pixel_proc__DOT__temp_edge_col_off = VL_RAND_RESET_I(32);
